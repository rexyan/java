										...
										<TABLE id=grid
											...
											<TBODY>
												...
												<TR
													...
													<TD>${cus.cust_linkman }</TD>
													<TD>${cus.cust_phone }</TD>
													<TD>${cus.cust_mobile }</TD>
													<TD>
													<!-- <a href="${pageContext.request.contextPath }/customerServlet?method=edit&custId=${cus.cust_id}">修改</a>
													&nbsp;&nbsp;
													<a href="${pageContext.request.contextPath }/customerServlet?method=delete&custId=${cus.cust_id}">删除</a>
													 -->
													</TD>
												</TR>
